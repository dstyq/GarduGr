        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary">
                    ...
                    <form method="POST" action="{{ route('schedule-maintenances.update', $schedule_maintenance->id) }}" enctype="multipart/form-data" id="form">
                        @method('patch')
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="code" value="{{ old('code') ?? $schedule_maintenance->code }}"
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="name" value="{{ old('name') ?? $schedule_maintenance->name }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="icheck-danger d-inline mr-3">
                                            <input type="radio" name="status" id="paused" {{( old('status') ?? $schedule_maintenance->status) == "0" ? "checked" : ""}}  value="0">
                                        ...
                                        <div class="icheck-success d-inline mr-5">
                                            <input type="radio" name="status" id="running" {{(old('status') ?? $schedule_maintenance->status) == "1" ? "checked" : ""}}  value="1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control float-right" id="dateRange" name="date_range" value="{{ old('date_range') ?? date('d/m/Y', strtotime($schedule_maintenance->start_date)) . ' - ' . date('d/m/Y', strtotime($schedule_maintenance->end_date)) }}">
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control  @error('work_order_status_id') is-invalid @enderror" name="work_order_status_id">
                                                    ...
                                                    @foreach ($work_order_statuses as $work_order_status)
                                                        <option value="{{ $work_order_status->id }}" {{ ((old('work_order_status_id') ?? $schedule_maintenance->work_order_status_id) == $work_order_status->id) ? 'selected' : '' }}>{{ $work_order_status->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control  @error('maintenance_type_id') is-invalid @enderror" name="maintenance_type_id">
                                                    ...
                                                    @foreach ($maintenance_types as $maintenances_type)
                                                        <option value="{{ $maintenances_type->id }}" {{ ((old('maintenance_type_id') ?? $schedule_maintenance->maintenance_type_id) == $maintenances_type->id) ? 'selected' : '' }}>{{ $maintenances_type->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control  @error('priority') is-invalid @enderror" name="priority">
                                                    ...
                                                    <option value="lowest" {{ ((old('priority') ?? $schedule_maintenance->priority) == 'lowest') ? 'selected' : '' }}>Lowest</option>
                                                    <option value="low" {{ ((old('priority') ?? $schedule_maintenance->priority) == 'low') ? 'selected' : '' }}>Low</option>
                                                    <option value="medium" {{ ((old('priority') ?? $schedule_maintenance->priority) == 'medium') ? 'selected' : '' }}>Medium</option>
                                                    <option value="high" {{ ((old('priority') ?? $schedule_maintenance->priority) == 'high') ? 'selected' : '' }}>High</option>
                                                    <option value="highest" {{ ((old('priority') ?? $schedule_maintenance->priority) == 'highest') ? 'selected' : '' }}>Highest</option>
                                                </select>
                                                @error('priority')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-inline mr-3">
                                            <input type="radio" name="schedule" onclick="scheduleSwitch();" id="day" {{(old('schedule') ?? $schedule_maintenance->schedule) == "day" ? "checked" : ""}}  value="day">
                                        ...
                                        <div class="d-inline mr-3">
                                            <input type="radio" name="schedule" onclick="scheduleSwitch();" id="week" {{(old('schedule') ?? $schedule_maintenance->schedule) == "week" ? "checked" : ""}}  value="week">
                                        ...
                                        <div class="d-inline mr-3">
                                            <input type="radio" name="schedule" onclick="scheduleSwitch();" id="month" {{(old('schedule') ?? $schedule_maintenance->schedule) == "month" ? "checked" : ""}}  value="month">
                                        ...
                                        <div class="d-inline">
                                            <input type="radio" name="schedule" onclick="scheduleSwitch();" id="year" {{(old('schedule') ?? $schedule_maintenance->schedule) == "year" ? "checked" : ""}}  value="year">
                                    ...
                                    <div class="form-group row day-group d-none">
                                        ...
                                        <div class="col-2">
                                            <input type="number"
                                                ...
                                                placeholder="Enter day" min="1" max="31" disabled='true'>                                            
                                        </div>
                                    ...
                                    <div class="form-group row week-group d-none">
                                        ...
                                        <div class="col-2">
                                            <input type="number"
                                                ...
                                                placeholder="Enter week" min="0" max="60" disabled='true'>                                            
                                        </div>
                                    ...
                                    <div class="form-group row month-group d-none">
                                        ...
                                        <div class="col-2">
                                            <input type="number"
                                                ...
                                                placeholder="Enter month" min="1" max="12" disabled='true'>                                            
                                        </div>
                                    ...
                                    <div class="form-group row year-group d-none">
                                        ...
                                        <div class="col-2">
                                            <input type="number"
                                                ...
                                                placeholder="Enter year" min="0" max="60" disabled='true'>                                            
                                        </div>
                                        <p class="col-2 col-form-label">years, on</p>
                                        <div class="col-4">
                                            <select class="form-control  @error('month') is-invalid @enderror" name="month" id="year-group-month" disabled='true'>
                                                @foreach ($months as $month)
                                                    <option value="{{ $loop->iteration }}" {{ ((old('month') ?? $schedule_maintenance->month) == $loop->iteration) ? 'selected' : '' }}>{{ $month }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-2">
                                    ...
                                    <div class="form-group row day-of-week-group d-none">
                                        <div class="custom-control custom-checkbox col-3">
                                          <input class="custom-control-input day-of-week" type="checkbox" id="monday" value="1" name="day_of_week[]" disabled='true' {{ is_array(old('day_of_week')) ? (in_array("1", old('day_of_week')) ? 'checked' : '') : (in_array("1", json_decode($schedule_maintenance->day_of_week ?? "[]")) ? 'checked' : '') }}>
                                          <label for="monday" class="custom-control-label">Monday</label>
                                        </div>
                                        <div class="custom-control custom-checkbox col-3">
                                          <input class="custom-control-input day-of-week" type="checkbox" id="tuesday" value="2" name="day_of_week[]" disabled='true' {{ is_array(old('day_of_week')) ? (in_array("2", old('day_of_week')) ? 'checked' : '') : (in_array("2", json_decode($schedule_maintenance->day_of_week ?? "[]")) ? 'checked' : '') }}>
                                          <label for="tuesday" class="custom-control-label">Tuesday</label>
                                        </div>
                                        <div class="custom-control custom-checkbox col-3">
                                          <input class="custom-control-input day-of-week" type="checkbox" id="wednesday" value="3" name="day_of_week[]" disabled='true' {{ is_array(old('day_of_week')) ? (in_array("3", old('day_of_week')) ? 'checked' : '') : (in_array("3", json_decode($schedule_maintenance->day_of_week ?? "[]")) ? 'checked' : '') }}>
                                          <label for="wednesday" class="custom-control-label">Wednesday</label>
                                        </div>
                                        <div class="custom-control custom-checkbox col-3">
                                          <input class="custom-control-input day-of-week" type="checkbox" id="thursday" value="4" name="day_of_week[]" disabled='true' {{ is_array(old('day_of_week')) ? (in_array("4", old('day_of_week')) ? 'checked' : '') : (in_array("4", json_decode($schedule_maintenance->day_of_week ?? "[]")) ? 'checked' : '') }}>
                                          <label for="thursday" class="custom-control-label">Thursday</label>
                                        </div>
                                        <div class="custom-control custom-checkbox col-3">
                                          <input class="custom-control-input day-of-week" type="checkbox" id="friday" value="5" name="day_of_week[]" disabled='true' {{ is_array(old('day_of_week')) ? (in_array("5", old('day_of_week')) ? 'checked' : '') : (in_array("5", json_decode($schedule_maintenance->day_of_week ?? "[]")) ? 'checked' : '') }}>
                                          <label for="friday" class="custom-control-label">Friday</label>
                                        </div>
                                        <div class="custom-control custom-checkbox col-3">
                                          <input class="custom-control-input day-of-week" type="checkbox" id="saturday" value="6" name="day_of_week[]" disabled='true' {{ is_array(old('day_of_week')) ? (in_array("6", old('day_of_week')) ? 'checked' : '') : (in_array("6", json_decode($schedule_maintenance->day_of_week ?? "[]")) ? 'checked' : '') }}>
                                          <label for="saturday" class="custom-control-label">Saturday</label>
                                        </div>
                                        <div class="custom-control custom-checkbox col-3">
                                            <input class="custom-control-input day-of-week" type="checkbox" id="sunday" value="7" name="day_of_week[]" disabled='true' {{ is_array(old('day_of_week')) ? (in_array("7", old('day_of_week')) ? 'checked' : '') : (in_array("0", json_decode($schedule_maintenance->day_of_week ?? "[]")) ? 'checked' : '') }}>
                                    ...
                                    <div class="form-group trigger-time mt-3 d-none">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <select class="form-control  @error('hour') is-invalid @enderror" name="hour" id="trigger-time-hour" disabled='true'>
                                                    @for ($i = 0; $i < 24; $i++)
                                                        <option value="{{ $i }}" {{ ((old('hour') ?? ($schedule_maintenance->hour ?? 1)) == $i) ? 'selected' : '' }}>{{ $i . ' : 00' }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  @error('asset_id') is-invalid @enderror" name="asset_id">
                                            ...
                                            @foreach ($assets as $asset)
                                                <option value="{{ $asset['id'] }}" {{ ((old('asset_id') ?? $schedule_maintenance->asset_id) == $asset['id']) ? 'selected' : '' }}>{{ $asset['name'] }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        @else
                                            @foreach ($schedule_maintenance->documents as $document)
                                                <input type="hidden" class="referenceId" name="referenceId[]" value="{{ $document->id }}">
                                            @endforeach
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('schedule-maintenances.index') }}" class="btn btn-secondary btn-footer">Back</a>
                        </div>
                    </form>
                </div>
            </div>
