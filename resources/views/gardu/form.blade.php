<tr id="form-{{ $gardu->id }}" style="display: none;">
    <td colspan="3">
        <form action="{{ route('impedansi-trafo.store') }}" method="POST" class="mb-3">
            ...
            <div class="d-flex justify-content-center">
                <button type="button" class="btn btn-secondary" id="calculateAll2Btn" data-gardu-id="{{ $gardu->id }}">Calculate All</button>
            </div>
            ...
            <div class="d-flex justify-content-center">
                <button type="button" class="btn btn-secondary" id="calculateX1Trafo2Btn" data-gardu-id="{{ $gardu->id }}">Calculate X1 Trafo</button>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.0001" name="r1gi_flt2" class="form-control" id="r1_gi_gh1_2_{{ $gardu->id }}" required readonly>
                </div>
                <div class="col-md-6">
                    <label for="x1_gi_gh1_2_{{ $gardu->id }}">X1 GI-GH1</label>
                    <input type="number" step="0.001" name="x1gi_flt1_2" class="form-control" id="x1_gi_gh1_2_{{ $gardu->id }}" required readonly>
                </div>
            </div>
            <div class="d-flex justify-content-center">
                <button type="button" class="btn btn-secondary" id="calculateAll4Btn" data-gardu-id="{{ $gardu->id }}">Calculate All</button>
            </div>
